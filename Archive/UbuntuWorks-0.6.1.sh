...
# OpenJavaJDK and Default Java JRE
	...
	sudo apt install -y openjdk-11-jdk-headless default-jre-headless fonts-dejavu-extra libatk-wrapper-java libatk-wrapper-java-jni openjdk-11-jre
	sudo apt install -y openjdk-13-jdk-headless
	sudo apt install -y openjdk-16-jdk-headless
	sudo apt install -y default-jre
	# Suggested Packages: openjdk-11-jdk-headless default-jre openjdk-11-demo openjdk-11-source fonts-dejavu-extra fonts-ipafont-gothic fonts-ipafont-mincho fonts-wqy-microhei | fonts-wqy-zenhei
...
# Qt 5
	...
	# Suggested Packages: clang-10-doc glibc-doc ncurses-doc libomp-10-doc libstdc++-9-doc libx11-doc libxcb-doc libxext-doc llvm-10-doc make-doc python-pygments-doc ttf-bitstream-vera default-libmysqlclient-dev firebird-dev libpq-dev libsqlite3-dev unixodbc-dev clazy cmake g++ git kate-data subversion valgrind
