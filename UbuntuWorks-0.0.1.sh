...
# Qt 5
	...
	sudo apt-get install -y qtbase5-dev qttools5-dev qttools5-dev-tools qtwebengine5-dev
	sudo apt install -y qt5-doc qt5-doc-html qtbase5-doc-html qtbase5-examples

# Anaconda
  # Install packages needed for Anaconda's GUI Navigator to build
...
# GNU Octive
	...
	sudo apt-get install -y octave-doc octave-info octave-htmldoc liboctave-dev
