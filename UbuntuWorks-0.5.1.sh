...
# Developer Tools
	sudo apt install -y gcc g++ gfortran git patch wget pkg-config liblapack-dev libmetis-dev liblapack-doc
...
# Qt 4
	sudo apt install -y qt4-default qtcreator
...
# Qt 6
	sudo apt install -y qt6-default qtcreator
	sudo apt install -y qtbase6-dev qttools6-dev qttools6-dev-tools qtwebengine6-dev
	sudo apt install -y qt6-doc qt6-doc-html qtbase6-doc-html qtbase6-examples
